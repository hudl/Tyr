import logging
from tyr.servers.iis import IISThorNode
from tyr.clusters.autoscaling import AutoScaler


class IISThorCluster():
    ...
    def __init__(self, group=None,
        ...
        self.log = logging.getLogger('Tyr.Clusters.IISThorCluster')
        self.group = group
        ...
        self.node = IISThorNode(group=self.group,
    ...
    def provision(self):
        self.log.info('Provisioning IISThorCluster')
        self.node.configure()
