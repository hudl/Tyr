...
policies = {
    ...
    'allow-modify-nginx-elbs-thor': elb.allow_modify_nginx_elbs_thor,
    ...
    'allow-lifecycle-nginx-thor': None,
    'allow-lifecycle-nginx-test': None,
    'allow-lifecycle-nginx-prod': ec2.allow_lifecycle_nginx_prod,
